...
[Route("api/v1/portfolio-control-center/advisor-performance")]
...
public sealed class PortfolioAdvisorPerformanceController(IPortfolioAdvisorPerformanceService service) : AnalyticsControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PortfolioAdvisorPerformanceResponse), StatusCodes.Status200OK)]
