...
[Route("api/v1/portfolio-control-center/campaign-performance")]
...
public sealed class PortfolioCampaignPerformanceController(IPortfolioCampaignPerformanceService service) : AnalyticsControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PortfolioCampaignPerformanceResponse), StatusCodes.Status200OK)]
