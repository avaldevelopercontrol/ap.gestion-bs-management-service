...
[Route("api/v1/portfolio-control-center/filter-options")]
...
public sealed class PortfolioFilterOptionsController(IPortfolioFilterOptionsService service) : AnalyticsControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PortfolioFilterOptionsResponse), StatusCodes.Status200OK)]
