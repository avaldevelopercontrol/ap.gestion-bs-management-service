...
[Route("api/v1/portfolio-control-center/supervisor-performance")]
...
public sealed class PortfolioSupervisorPerformanceController(IPortfolioSupervisorPerformanceService service) : AnalyticsControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PortfolioSupervisorPerformanceResponse), StatusCodes.Status200OK)]
