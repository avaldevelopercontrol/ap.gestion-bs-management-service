...
[Route("api/v1/portfolio-control-center/overview")]
...
public sealed class PortfolioOverviewController(IPortfolioOverviewService service) : AnalyticsControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PortfolioOverviewResponse), StatusCodes.Status200OK)]
