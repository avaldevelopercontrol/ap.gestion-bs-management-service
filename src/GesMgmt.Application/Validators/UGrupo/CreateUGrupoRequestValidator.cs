...
namespace GesMgmt.Application.Validators.UGrupo
{
    public class CreateUGrupoRequestValidator
    {
        ...
        private PostUsuarioGrupoCrearRequestDto _requestDto;

        public CreateUGrupoRequestValidator(
            IUnitOfWork unitOfWork,
            IValidationMessageService validationMessageService,
            PostUsuarioGrupoCrearRequestDto requestDto)
        {
        ...
        public async Task<ResultDto<PostUsuarioGrupoCrearResponseDto>> Validate()
        {
            ...
            return ResultDto<PostUsuarioGrupoCrearResponseDto>.Success(default, Const.SUCCESS_CODE, Const.SUCCESS_MESSAGE, Const.SUCCESS_MESSAGE, Const.OK_REQUEST_CODE);
        }

        private async Task<ResultDto<PostUsuarioGrupoCrearResponseDto>> ValidateUsuario()
        {
            if (_requestDto.nId_Usuario == null)
            {
                ...
                return ResultDto<PostUsuarioGrupoCrearResponseDto>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }
        ...
        private async Task<ResultDto<PostUsuarioGrupoCrearResponseDto>> ValidateGrupo()
        {
