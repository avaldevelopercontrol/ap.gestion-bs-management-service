...
{
    public class CreateOpcionRequestValidator
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IValidationMessageService _validationMessageService;
        private ValidationMessageDto _oValMsgDto;
        private CreateOpcionRequestDto _requestDto;

        public CreateOpcionRequestValidator(
            IUnitOfWork unitOfWork,
            IValidationMessageService validationMessageService,
            CreateOpcionRequestDto requestDto)
        {
        ...
        public async Task<ResultDto<CreateOpcionResponseDto>> Validate()
        {
            #region Default
            ...
            #endregion
            return ResultDto<CreateOpcionResponseDto>.Success(default, Const.SUCCESS_CODE, Const.SUCCESS_MESSAGE, Const.SUCCESS_MESSAGE, Const.OK_REQUEST_CODE);
        }

        private async Task<ResultDto<CreateOpcionResponseDto>> ValidateCodigoOpcion()
        {
            ...
            if (string.IsNullOrEmpty(_requestDto.sCodigoOpcion))
            {
                ...
                return ResultDto<CreateOpcionResponseDto>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }
            return ResultDto<CreateOpcionResponseDto>.Success(default, Const.SUCCESS_CODE, Const.SUCCESS_MESSAGE, Const.SUCCESS_MESSAGE, Const.OK_REQUEST_CODE);
        }

        private async Task<ResultDto<CreateOpcionResponseDto>> ValidateNombreOpcion()
        {
        ...
        private async Task<ResultDto<CreateOpcionResponseDto>> ValidateUrlOpcion()
        {
        ...
        private async Task<ResultDto<CreateOpcionResponseDto>> ValidateTipoOpcion()
        {
        ...
        private async Task<ResultDto<CreateOpcionResponseDto>> ValidateOrdenOpcion()
        {
