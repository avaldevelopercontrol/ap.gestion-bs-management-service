...
public sealed record PortfolioEvolutionRequest(
    string? Campaign,
    long? SubPortfolioId,
    DateOnly? DateFrom,
    DateOnly? DateTo)
{
    ...
    public static bool TryCreate(
        ...
        string? dateFrom,
        string? dateTo,
        out PortfolioEvolutionRequest? request,
        out Dictionary<string, string[]> errors)
    {
        ...
        request = new PortfolioEvolutionRequest(
            normalizedCampaign,
    ...
    public bool TryResolveRange(
        ...
        out PortfolioEvolutionRange range,
        out Dictionary<string, string[]> errors)
    {
        errors = [];

        var dateFrom = DateFrom ?? context.StartDate;
        var dateTo = DateTo ?? context.LatestEvolutionDate ?? context.EndDate;
        ...
        range = new PortfolioEvolutionRange(dateFrom, dateTo);
        return true;
    }
